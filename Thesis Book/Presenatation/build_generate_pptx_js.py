...
js_code = r"""const pptxgen = require('pptxgenjs');
...
target_file = r'c:\Users\shahrear\Downloads\LTSpice\Thesis\Thesis Book\Presenatation\generate_pptx.js'
with open(target_file, 'w', encoding='utf-8') as f:
    f.write(js_code)

print("Updated generate_pptx.js cleanly!")

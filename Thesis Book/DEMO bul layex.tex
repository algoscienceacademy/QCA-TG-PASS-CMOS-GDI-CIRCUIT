...
{\fontsize{18}{22}\selectfont
  \sffamily\bfseries \MakeUppercase{An Ultra Low Power 10 Transistor 1 Bit Magnitude Comparator Using Gate Diffusion Input Technique}\par}
...
\bfseries { BACHELOR OF SCIENCE IN ELECTRICAL AND ELECTRONIC 
\\ ENGINEERING\\}

\vspace{2.5cm}

\includegraphics[width=3.5cm ,height = 3cm]{iiuc_logo.jpg}

\vspace{1cm}

{\mdseries Department of Electrical and Electronic Engineering\\
INTERNATIONAL ISLAMIC UNIVERSITY CHITTAGONG}

\vspace{0.5cm}
\MakeUppercase {\mdseries {October} 2026}
\end{center}
\clearpage
...
\vspace*{0.5cm}
{{\fontsize{18}{22}\selectfont
  \rmfamily\bfseries\MakeUppercase{An Ultra Low Power 10 Transistor 1 Bit Magnitude Comparator Using Gate Diffusion Input Technique}\par}
...
{\mdseries Department of Electrical and Electronic Engineering\\ INTERNATIONAL ISLAMIC UNIVERSITY CHITTAGONG}
...
\noindent The thesis entitled {\bfseries{``An Ultra Low Power 10 Transistor 1 Bit Magnitude Comparator Using Gate Diffusion
Input Technique'' }} submitted by {\bfseries{Shahrear Hossain}}, bearing Matric ID: {\bfseries{ET223104 }} of the session {\bfseries {Autumn 2022}}, to the Department of Electrical and Electronic Engineering, International Islamic University Chittagong, has been accepted as satisfactory in partial fulfilment of the requirements for the degree of Bachelor of Science in Engineering and approved at the examination held on {\bfseries{October 2026}}.
...
\begin{tabular}{l}
    ...
    \textbf{Signature of the Supervisor} \\[0.2cm]
    Riazul Islam \\
    Lecturer \\
    Department of Electrical and Electronic Engineering \\
    International Islamic University Chittagong
